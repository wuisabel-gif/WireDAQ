...
Pure standard library; no build step. Run from the repo root:

    python3 run_slice.py
    python3 run_slice.py --nodes 3 --packets 200 --loss 0.05 --reorder 0.03 --seed 7
"""
...
# Allow `python3 run_slice.py` from anywhere by anchoring the repo root.
sys.path.insert(0, str(Path(__file__).resolve().parent))

from ground_station.dashboard import ConsoleDashboardSink  # noqa: E402
from ground_station.logger import RawFrameLogger  # noqa: E402
