...
implementation of the layout described in `src/wiredaq/protocol/packet_schema.yaml`, used to
*generate and verify* the golden vectors in `src/wiredaq/protocol/golden/vectors.json`.

Both the Python simulator codec (src/wiredaq/daq_sim) and the C firmware codec must
